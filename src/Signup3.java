        ...
        try{
            if(ae.getSource()==b1){
                ...
                if(atype.equals("")){
                    ...
                    conn c1 = new conn();
                    String q1 = "insert into signup3(Formno,Accounttype,CardNo,Pin,Facility) values('"+formno+"','"+atype+"','"+cardno+"','"+pin+"','"+facility+"')";  
                    String q2 = "insert into loginmain(Formno,CardNo,Pin) values('"+formno+"','"+cardno+"','"+pin+"')";
